...
namespace PetVaccinationTrackerSystem_Project
{
    public partial class TablePetProfile : UserControl
    {
        ...
        private void LoadComboBox()
        {
            ...
            cmbFilterSpecies.Items.Add("Dog");
            cmbFilterSpecies.Items.Add("Cat");
        ...
        public void LoadData()
        {
            ...
            using (var context = new ModelContext())
            {
                ...
                dgvPetProfile.DataSource = pet;

                dgvPetProfile.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.AllCells;
                dgvPetProfile.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.AllCells;

                dgvPetProfile.Columns["PetID"].HeaderText = "Pet ID";
                dgvPetProfile.Columns["UserID"].HeaderText = "User ID";
                dgvPetProfile.Columns["PetName"].HeaderText = "Pet Name";
                dgvPetProfile.Columns["Gender"].HeaderText = "Gender";
                dgvPetProfile.Columns["Species"].HeaderText = "Species";
                dgvPetProfile.Columns["Breed"].HeaderText = "Breed";
                dgvPetProfile.Columns["OwnerName"].HeaderText = "Owner Name";
                dgvPetProfile.Columns["OwnerPhoneNumber"].HeaderText = "Owner Phone Number";
